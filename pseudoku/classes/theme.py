...
class Theme:
    ...
    def from_dict(theme_dict: dict[str, str]) -> "Theme":
        return Theme(
            background_colour=Colour.from_dict(
                theme_dict["background_colour"]),
            complementary_colour=Colour.from_dict(
                theme_dict["complementary_colour"]),
    ...
    def DEFAULT() -> "Theme":
        return Theme(
            background_colour=Colour.from_hex(
                DEFAULT_THEME["background_colour"]),
            complementary_colour=Colour.from_hex(
                DEFAULT_THEME["complementary_colour"]),
